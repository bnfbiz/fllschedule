...
public class Schedule {
    ...
    public Schedule(Scheduler schedulerInfo, TeamList teamList) {
        ...
        System.out.println("Practice: roundStartTeam: " + roundStartTeam + " roundEndTeam: " + roundEndTeam + " Practice1 start time: " + roundStartTime);
        ...
        System.out.println("Round1: roundStartTeam: " + roundStartTeam + " roundEndTeam: " + roundEndTeam + " Practice1 start time: " + roundStartTime);
        ...
        System.out.println("Round2: roundStartTeam: " + roundStartTeam + " roundEndTeam: " + roundEndTeam + " Practice1 start time: " + roundStartTime);
        ...
        System.out.println("Round3: roundStartTeam: " + roundStartTeam + " roundEndTeam: " + roundEndTeam + " Practice1 start time: " + roundStartTime);
        ...
        for (int t = roundStartTeam; t < roundEndTeam; t += gameTablePairs*2) {
            ...
            switch (wildcardTeamCount) {
                ...
                case 3:
                    ...
                    team2 = teamList.getWildCardTeam();
                    schedule[slot][t] = new ScheduleSlot(team1.getTeamNumber(), slotType, ScheduleSlot.Location.TABLE_BLUEA, matchTime.getHour(), matchTime.getMinute(), blockStartTime, matchDuration);
                    schedule[slot][wildCardTeamSlot] = new ScheduleSlot(team2.getTeamNumber(), slotType, ScheduleSlot.Location.TABLE_BLUEB, matchTime.getHour(), matchTime.getMinute(), blockStartTime, matchDuration);
                    matchTime = addHourMinutes(matchTime, LocalTime.of(0, matchDuration));
                    break;
                default:
                    System.out.println("Invalid wildcard team count");
